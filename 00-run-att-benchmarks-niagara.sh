#!/bin/bash
#SBATCH --job-name=attbenchmark
#SBATCH --output=attbenchmark.txt
#SBATCH --nodes=1
#SBATCH --ntasks=40
...
# Run the R script
Rscript dev/01-att-bench-matrix-calculation.r
Rscript dev/02-att-bench-matrix-functions.r
Rscript dev/03-att-bench-programmation.r
