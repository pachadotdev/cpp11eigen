clean:
	...
	@Rscript -e 'devtools::clean_dll("cpp11eigentest")'
...
test:
	...
	@echo "Testing C++ code"
	@Rscript -e 'devtools::load_all("cpp11eigentest"); devtools::test("cpp11eigentest")'

check:
	@echo "Local"
	@Rscript -e 'devtools::document()'
	@Rscript -e 'devtools::check(); devtools::check("cpp11eigentest")'
