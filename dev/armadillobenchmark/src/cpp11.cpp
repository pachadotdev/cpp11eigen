...
// 04_balassa_index.cpp
doubles_matrix<> balassa_arma_(const doubles_matrix<>& x);
extern "C" SEXP _armadillobenchmark_balassa_arma_(SEXP x) {
  BEGIN_CPP11
...
static const R_CallMethodDef CallEntries[] = {
    {"_armadillobenchmark_balassa_arma_",               (DL_FUNC) &_armadillobenchmark_balassa_arma_,               1},
